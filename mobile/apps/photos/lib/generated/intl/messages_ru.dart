...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "cLDesc2": MessageLookupByLibrary.simpleMessage(
            "Теперь вы можете автоматически добавлять фотографии выбранных людей в любой альбом. Просто перейдите в альбом и выберите \"автодобавление людей\" в меню переполнения. При использовании вместе с общим альбомом вы можете делиться фотографиями без единого клика."),
        "cLDesc3": MessageLookupByLibrary.simpleMessage(
            "Мы добавили возможность группировать галерею по неделям, месяцам и годам. Теперь вы можете настроить свою галерею так, чтобы она выглядела именно так, как вы хотите, с этими новыми параметрами группировки, а также с пользовательскими сетками."),
        "cLDesc4": MessageLookupByLibrary.simpleMessage(
            "Наряду с множеством внутренних улучшений для повышения качества прокрутки галереи, мы также изменили дизайн полосы прокрутки, чтобы показывать маркеры, позволяющие быстро переходить по временной шкале."),
        "cLTitle1": MessageLookupByLibrary.simpleMessage(
            "Расширенный редактор изображений"),
        "cLTitle2": MessageLookupByLibrary.simpleMessage("Умные альбомы"),
        "cLTitle3": MessageLookupByLibrary.simpleMessage("Улучшенная галерея"),
        "cLTitle4":
            MessageLookupByLibrary.simpleMessage("Более быстрая прокрутка"),
        "cachedData":
